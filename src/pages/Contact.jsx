                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full backdrop-blur-md mb-8">
                            ...
                            <span className="text-white/80 font-bold text-[11px] tracking-[0.2em] uppercase">Global Reach</span>
                        </div>
                        <h1 className="text-5xl md:text-7xl font-bold font-serif text-white leading-[1.1] mb-8">
                            Connect with <br />
            ...
            <section className="py-24 lg:py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-16 lg:gap-24 relative z-20 -mt-10">
                ...
                <div className="flex-1">
                    ...
                    >
                        ...
                        <div className="mb-12">
                            <h2 className="text-3xl font-bold font-serif text-[#0F172A] mb-4">Initialize Inquiry</h2>
                        ...
                        <form onSubmit={onSubmit} className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-2 relative group">
                                    <label className="text-[11px] font-bold text-[#94A3B8] uppercase tracking-[0.15em] ml-1 group-focus-within:text-[#B8860B] transition-colors">Principal Name</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                            <User className="h-5 w-5 text-gray-400 group-focus-within:text-[#B8860B] transition-colors" />
                                        </div>
                                        <input name="name" required type="text" className="w-full bg-[#F8FAFC] border border-gray-200 rounded-xl pl-12 pr-6 py-4 text-sm text-[#0F172A] focus:ring-2 focus:ring-[#B8860B]/20 focus:border-[#B8860B] outline-none transition-all placeholder:text-gray-400" placeholder="Full legal name" />
                                    </div>
                                </div>
                                <div className="space-y-2 relative group">
                                    <label className="text-[11px] font-bold text-[#94A3B8] uppercase tracking-[0.15em] ml-1 group-focus-within:text-[#B8860B] transition-colors">Corporate Email</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                            <Mail className="h-5 w-5 text-gray-400 group-focus-within:text-[#B8860B] transition-colors" />
                                        </div>
                                        <input name="email" required type="email" className="w-full bg-[#F8FAFC] border border-gray-200 rounded-xl pl-12 pr-6 py-4 text-sm text-[#0F172A] focus:ring-2 focus:ring-[#B8860B]/20 focus:border-[#B8860B] outline-none transition-all placeholder:text-gray-400" placeholder="institutional@enterprise.com" />
                                    </div>
                                </div>
                            </div>
                            <div className="space-y-2 relative group">
                                <label className="text-[11px] font-bold text-[#94A3B8] uppercase tracking-[0.15em] ml-1 group-focus-within:text-[#B8860B] transition-colors">Jurisdiction / Subject</label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <Briefcase className="h-5 w-5 text-gray-400 group-focus-within:text-[#B8860B] transition-colors" />
                                    </div>
                                    <input name="subject" required type="text" className="w-full bg-[#F8FAFC] border border-gray-200 rounded-xl pl-12 pr-6 py-4 text-sm text-[#0F172A] focus:ring-2 focus:ring-[#B8860B]/20 focus:border-[#B8860B] outline-none transition-all placeholder:text-gray-400" placeholder="Brief subject of advisory" />
                                </div>
                            </div>
                            <div className="space-y-2 relative group">
                                <label className="text-[11px] font-bold text-[#94A3B8] uppercase tracking-[0.15em] ml-1 group-focus-within:text-[#B8860B] transition-colors">Detailed Briefing</label>
                                <div className="relative">
                ...
                <div className="w-full lg:w-[420px] space-y-8 lg:mt-12">
                    <motion.div 
                        ...
                        transition={{ duration: 0.8 }}
                    >
                        <h3 className="text-2xl font-bold font-serif text-[#0F172A] mb-8 flex items-center gap-4">
                            Global Hubs
                                    ...
                                    <div className="space-y-6">
                                        {office.address && (
                                            <div className="flex gap-4 group/item items-start">
                                                ...
                                                <span className="text-[13px] font-medium text-[#64748B] leading-relaxed pt-1">{office.address}</span>
                                            </div>
                                        )}
                                        {office.phone && (
                                            <div className="flex gap-4 group/item items-center relative overflow-hidden">
                                                ...
                                                <a href={`tel:${office.phone.replace(/\s+/g, '')}`} className="text-[14px] font-bold text-[#0F172A] hover:text-[#B8860B] transition-colors">{office.phone}</a>
                                            </div>
                                        )}
                                        <div className="flex gap-4 group/item items-center">
                                            ...
                                            <a href={`mailto:${office.email}`} className="text-[13px] font-medium text-[#0F172A] hover:text-[#B8860B] transition-colors break-all">{office.email}</a>
                                        </div>
                                    </div>
                                </div>
                            ))}
                    ...
                    >
                        ...
                        <h4 className="text-[11px] font-bold text-white/50 uppercase tracking-[0.2em] mb-6 relative z-10">Intelligence Network</h4>
                        <div className="flex gap-4 relative z-10">
                            {[Facebook, Linkedin, Twitter].map((Icon, idx) => (
                                <motion.a
                                    key={idx}
                                    whileHover={{ y: -4, scale: 1.05 }}
                                    className="h-12 w-12 border border-white/10 rounded-full bg-white/5 flex items-center justify-center text-white/80 hover:bg-[#B8860B] hover:text-white hover:border-[#B8860B] transition-all shadow-sm"
                                    href="#"
                                >
