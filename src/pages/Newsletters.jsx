                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            {filteredNewsletters.map((item, idx) => (
                                ...
                                >
                                    <div className="flex flex-col h-full bg-white p-8 md:p-12 rounded-[2rem] border border-border shadow-soft hover:shadow-premium transition-all duration-700">
                                        ...
                                        <p className="text-xl text-text-main font-medium mb-8 leading-relaxed">
                                            {item.description}
                                        </p>
                                        ...
                                        <div className="space-y-4 mb-12 flex-grow">
                                            {item.items.map((bullet, bIdx) => (
                                                <div key={bIdx} className="flex gap-4 group/item">
                                                    ...
                                                    <span className="text-text-muted text-base leading-relaxed group-hover/item:text-text-main transition-colors">
                                                        {bullet}
                                                    </span>
                                                </div>
                                            ))}
                                        ...
                                        <div className="pt-8 border-t border-border flex items-center justify-between">
                                            <button className="flex items-center gap-2 text-sm font-bold uppercase tracking-[0.2em] text-primary hover:text-brand transition-colors group/btn">
                                                Read Full Analysis
                    ...
                    {filteredNewsletters.length === 0 && (
                        <div className="py-20 text-center">
                            <h3 className="text-3xl font-display text-text-muted">No newsletters found matching your search.</h3>
                        </div>
                    )}
                </div>
            </section>
                    ...
                    <div className="bg-primary rounded-[3rem] p-12 md:p-20 relative overflow-hidden text-white">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                            <div>
                                ...
                                <p className="text-white/70 text-xl mb-10 max-w-lg">
